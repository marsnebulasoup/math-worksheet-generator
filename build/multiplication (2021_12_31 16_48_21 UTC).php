...
<div style="padding-top:20px" class="container">
    <center><h1 style="font-family: Montserrat;" >Create a multiplication worksheet</h1></center>    
        <form action="../go" method="POST">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label  for="top">Top number range</label>
                    <input type="text" name="top" class="form-control" id="top" placeholder="eg. 1-10" maxlength="5" required>
                </div>
                <div class="form-group col-md-6">
                    <label  for="bottom">Bottom number range</label>
			...
			<center><button name="submit3" type="submit" class="btn btn-lg btn-outline-primary">Generate PDF</button></center>
            </div>
        </form>
