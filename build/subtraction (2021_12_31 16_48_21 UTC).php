...
<div style="padding-top:20px;" class="container">
    <center><h1 style="font-family: Montserrat;" >Create a subtraction worksheet</h1></center>
        ...
        <form action="../go" method="POST">
            ...
            <div class="form-row">
				...
				<div class="form-group col-md-12">
						...
						<label>
							<input type="checkbox" name="noknok" id="noknok" value="noknok" checked />
							<span>If checked, the program will automatically make sure that there are no negative answers to the equations</span>
						</label>
			...
			<center><button name="submit2" type="submit" class="btn btn-lg btn-outline-primary">Generate PDF</button></center>
            </div>
        </form>
    </div>
